            ...
            string User_Shape_of_Head, string User_Starch_Content)
        {
            ...
            foreach (var item in plants)
            {
                bool extrafield_Name = string.IsNullOrEmpty(User_Name)
                    || string.Equals(item?.Name, User_Name,
                    StringComparison.OrdinalIgnoreCase);

                bool extrafield_Type = string.IsNullOrEmpty(User_Type)
                    || string.Equals(item?.Type,
                    User_Type, StringComparison.OrdinalIgnoreCase);

                bool extrafield_Author = string.IsNullOrEmpty(User_Author)
                    || string.Equals(item?.Author,
                    User_Author, StringComparison.OrdinalIgnoreCase);

                bool extrafield_MaturationTime = string.IsNullOrEmpty(User_Maturation_Time)
                    || string.Equals(item?.Maturation_Time,
                    User_Maturation_Time, StringComparison.OrdinalIgnoreCase);

                bool extrafield_Weight = string.IsNullOrEmpty(User_Weight)
                    || string.Equals(item?.Weight,
                    User_Weight, StringComparison.OrdinalIgnoreCase);

                bool extrafield_Hybridity = string.IsNullOrEmpty(User_Hybridity)
                    || string.Equals(item?.Hybridity,
                    User_Hybridity, StringComparison.OrdinalIgnoreCase);

                bool extrafield_Frost_Resistance = string.IsNullOrEmpty(User_Frost_Resistance)
                    || string.Equals(item?.Frost_Resistance,
                    User_Frost_Resistance, StringComparison.OrdinalIgnoreCase);

                bool extrafield_ExpirationDate = string.IsNullOrEmpty(User_Expiration_Date)
                    || string.Equals(item?.Expiration_Date,
                    User_Expiration_Date, StringComparison.OrdinalIgnoreCase);

                bool extrafield_Potential_Harvest = string.IsNullOrEmpty(User_Potential_Harvest)
                    || string.Equals(item?.Potential_Harvest,
                    User_Potential_Harvest, StringComparison.OrdinalIgnoreCase);

                bool extrafield_TypePollution = string.IsNullOrEmpty(User_Type_Pollution)
                    || string.Equals(item?.Type_of_Pollution,
                    User_Type_Pollution, StringComparison.OrdinalIgnoreCase);

                bool extrafield_Cuboid = string.IsNullOrEmpty(User_Cuboid)
                    || string.Equals(item?.Is_Cuboid,
                    User_Cuboid, StringComparison.OrdinalIgnoreCase);

                bool extrafield_Indeterminate = string.IsNullOrEmpty(User_Indeterminate)
                    || string.Equals(item?.Is_Indeterminate,
                    User_Indeterminate, StringComparison.OrdinalIgnoreCase);

                bool extrafield_ShapeHead = string.IsNullOrEmpty(User_Shape_of_Head)
                    || string.Equals(item?.Shape_of_Head,
                    User_Shape_of_Head, StringComparison.OrdinalIgnoreCase);

                bool extrafield_Starch_Content = string.IsNullOrEmpty(User_Starch_Content)
                    || string.Equals(item?.Starch_Content,
                    User_Starch_Content, StringComparison.OrdinalIgnoreCase);
